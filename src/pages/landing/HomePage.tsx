    ...
    <section className=" min-h-screen moneypoint-blue-gradient flex justify-center items-center">
      <div className=" text-center">
        ...
        <div className=" mt-12 grid grid-cols-2 gap-10">
          <div onClick={ () => {navigate("/auth/ticket-ref")}} className=" h-56 w-96 bg-white rounded-lg flex items-center justify-center shadow-sm cursor-pointer hover:shadow-lg">
		  ...
		  <div onClick={ () => {navigate("/auth/view-faq")}} className=" h-56 w-96 bg-white rounded-lg flex items-center justify-center shadow-sm cursor-pointer hover:shadow-lg">
            <div className=" text-center space-y-3">
